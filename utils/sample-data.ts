...
export const initialExercises: ExerciseSeed[] = [
  ...
  weightExercise("Walking Lunge", "legs", "glutes", ["Bodyweight", "Dumbbells"], ["lunge"], "Unilateral leg movement for strength and control."),
  weightExercise("Bodyweight Squat", "legs", "quads", ["Bodyweight"], ["air squat"], "No-equipment squat pattern for home training."),
  weightExercise("Reverse Lunge", "legs", "glutes", ["Bodyweight"], ["bodyweight lunge", "alternating reverse lunge"], "Simple unilateral leg movement without external load."),
  weightExercise("Glute Bridge", "legs", "glutes", ["Bodyweight"], ["bridge"], "Floor-based glute movement with no equipment required."),
  ...
  weightExercise("Pike Push-Up", "shoulders", "shoulders", ["Bodyweight"], ["pike push up"], "Bodyweight pressing variation with more shoulder involvement."),
  ...
  weightExercise("Prone Back Extension", "pull", "back", ["Bodyweight"], ["superman raise"], "Bodyweight back-extension movement for posterior-chain endurance."),
  ...
  timedExercise("Bird Dog", "core", "core", ["Bodyweight"], ["quadruped bird dog"], "Controlled trunk-stability drill for home training."),
  timedExercise("Wall Sit", "legs", "quads", ["Bodyweight"], ["wall squat"], "Simple lower-body endurance hold with no equipment."),
  timedExercise("Mountain Climber", "conditioning", "conditioning", ["Bodyweight"], ["mountain climbers"], "No-equipment conditioning drill with a core demand."),
  timedExercise("Superman Hold", "pull", "back", ["Bodyweight"], ["superman"], "Posterior-chain hold for back and glute endurance."),
