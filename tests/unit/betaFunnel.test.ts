  ...
  it("summarizes monetization conversion counts and rates", () => {
      ...
      users: [
        {
          betaFunnel: {
            ...
            weeklyProBriefViewedAt: "2026-03-10T00:15:00.000Z",
            pricingPageViewSources: { pricing_page_authenticated: 1 },
            checkoutStartSources: { pricing_trial_month: 1 },
            weeklyProBriefViewSources: { routines_pro_weekly_brief: 1 },
          },
          paid: true,
        },
        {
    ...
    expect(summary).toEqual({
      ...
      sourceBreakdown: {
        ...
        checkoutStarts: { pricing_trial_month: 1 },
        weeklyProBriefViews: { routines_pro_weekly_brief: 1 },
      },
    });
  });
